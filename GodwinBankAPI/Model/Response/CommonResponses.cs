...
public static class CommonResponses
{
    ...
    public static class ErrorResponse
    {
        ...
        public static BaseResponse<T> FailedDependencyErrorResponse<T>(string message =null) =>
            new BaseResponse<T>()
            {
                Code = (int)HttpStatusCode.FailedDependency,
                Message = FailedDependencyErrorResponseMessage ?? message
            };
        ...
        public static BaseResponse<T> ForbidErrorResponse<T>(string message) =>
            new BaseResponse<T>()
            {
                Code = (int)HttpStatusCode.Conflict,
                Message = message
    ...
    { 
        ...
        public static BaseResponse<T> OkResponse<T>( string message) => 
            new BaseResponse<T> 
            { 
                Code = (int)HttpStatusCode.OK, 
                Message = message,
